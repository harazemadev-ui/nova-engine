...
def generate(context: ModuleContext) -> ModuleResult:
    ...
    try:
        ...
        if not text:
            return ModuleResult("Gemini returned an empty response.")
        ...
        return ModuleResult(f"Gemini API Is currently unavalabel")

    except Exception as e:
        print(f"Gemini error: {e}")

        return ModuleResult("Nova is working! Gemini is temporarily unavailable.")
